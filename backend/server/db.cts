...
module.exports = async function() {
    ...
    ----------------------------
    1. Retrieves pre-configured MongoDB client from main.cts
	...
	const l_coDb = (await require("./main.cts").get("Database connection").connect()).db(process.env.DB_NAME)
	g_cToggleProcessing()
	console.log("Database connected.")
	for (const [l_csCollectionName, l_coValidator] of require("./data.cts").get("Objects").entries()) {
