...
.. ts:function:: l_oFindById(a_oRequest, a_oResponse)
...
.. ts:function:: l_oCFindByOrganiser(a_oRequest, a_oResponse)
...
.. ts:function:: l_oCFindByAttendee(a_oRequest, a_oResponse)
