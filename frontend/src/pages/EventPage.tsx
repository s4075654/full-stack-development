...
function EventDetail() {
  ...
  useEffect(() => {
    // Only set tempDescription if this is the owner's event
    if (currentEvent?.discussionDescription && isOwner) {
      setTempDescription(currentEvent.discussionDescription);
    } else {
      setTempDescription(''); // Reset for non-owners or new events
    }
  }, [currentEvent?.discussionDescription, isOwner]);
            ...
            <div className="max-w-7xl mx-auto">
              ...
              (!invitation || invitation.status !== "Accepted") ? (
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                  ...
                  {/* Discussion Board Section - Always visible */}
                            ...
                            <div 
                              ...
                              onClick={() => {
                                if (!isEditingDescription) {
                                  ...
                                  setTempDescription(currentEvent.discussionDescription || ''); // Set initial value when starting to edit
                                }
                              }}
                            >
                              {isEditingDescription ? (
